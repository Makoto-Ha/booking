		...
		<div class="main-content">
			...
			<form class="form" action="../create" method="post">
		        <div class="form-group">
		            ...
		            <input type="text" id="roomtype-name" name="roomtypeName" placeholder="輸入內容" required>
		        </div>
		        ...
		        <div class="form-group">
		            ...
		            <input type="text" id="description" name="roomtypeAddress" placeholder="輸入內容" required>
		        </div>
