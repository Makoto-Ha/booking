		...
		<div class="main-content">
			...
			<form class="form" action="update">
		        ...
		        <div class="form-group">
		            ...
		            <input type="number" id="price" name="roomtype-price" placeholder="輸入內容" value="${roomtype.getRoomtypePrice()}">
		        </div>
		
		        <div class="form-group">
		            <label for="quantity">房間數量</label>
		            <input type="number" id="quantity" name="roomtype-quantity" placeholder="輸入內容" value="${roomtype.getRoomtypeQuantity()}">
		        </div>
		
		        <div class="form-group">
		            <label for="description">房間類型介紹 (四個中文，至少八個字)</label>
		            <input type="text" id="description" name="roomtype-description" placeholder="輸入內容" value="${roomtype.getRoomtypeDescription()}">
		        </div>
		        ...
		        <div class="form-group">
		            ...
		            <input type="text" name="roomtype-address" placeholder="輸入內容" value="${roomtype.getRoomtypeAddress()}">
		        </div>
		        ...
		        <div class="form-group roomtype-capacity-group">
		            <div class="choose-roomtype-capacity">
			            <label class="radio-label">
			            	一人房
			                <input type="radio" name="roomtype-capacity" value="1" ${roomtype.getRoomtypeCapacity() == '1' ? 'checked' : '' }>
			            </label>
		            </div>
		            <div class="choose-roomtype-capacity">
			            <label class="radio-label">
			            	兩人房
			                <input type="radio" name="roomtype-capacity" value="2" ${roomtype.getRoomtypeCapacity() == '2' ? 'checked' : '' }>
			            </label>
		            </div>
		            <div class="choose-roomtype-capacity">
			            <label class="radio-label">
			            	三人房
			                <input type="radio" name="roomtype-capacity" value="3" ${roomtype.getRoomtypeCapacity() == '3' ? 'checked' : '' }>
			            </label>
		            </div>
	             	<div class="choose-roomtype-capacity">
			            <label class="radio-label">
			            	四人房
			                <input type="radio" name="roomtype-capacity" value="4" ${roomtype.getRoomtypeCapacity() == '4' ? 'checked' : '' }>
			            </label>
		            </div>
		            <div class="choose-roomtype-capacity">
			            <label class="radio-label">
			            	五人房
			                <input type="radio" name="roomtype-capacity" value="5" ${roomtype.getRoomtypeCapacity() == '5' ? 'checked' : '' }>
			            </label>
		            </div>
		        </div>
