		...
		<div class="main-content">
			...
			<form class="form" action="../update" method="post">
		        <div class="form-group">
		            ...
		            <input type="text" id="roomtype-name" name="roomtypeName" placeholder="輸入內容" value="${roomtype.roomtypeName}">
		        </div>
		
		        <div class="form-group">
		            <label for="price">房間類型價格</label>
		            <input type="number" id="price" name="roomtypePrice" placeholder="輸入內容" value="${roomtype.roomtypePrice}">
		        </div>
		
		        <div class="form-group">
		            <label for="quantity">房間數量</label>
		            <input type="number" id="quantity" name="roomtypeQuantity" placeholder="輸入內容" value="${roomtype.roomtypeQuantity}">
		        </div>
		
		        <div class="form-group">
		            <label for="description">房間類型介紹 (四個中文，至少八個字)</label>
		            <input type="text" id="description" name="roomtypeDescription" placeholder="輸入內容" value="${roomtype.roomtypeDescription}">
		        </div>
		        ...
		        <div class="form-group">
		            ...
		            <input type="text" name="roomtypeAddress" placeholder="輸入內容" value="${roomtype.roomtypeAddress}">
		        </div>
		        ...
		        <div class="form-group roomtype-capacity-group">
		            <div class="choose-roomtype-capacity">
			            <label class="radio-label">
			            	一人房
			                <input type="radio" name="roomtypeCapacity" value="1" ${roomtype.roomtypeCapacity == '1' ? 'checked' : '' }>
			            </label>
		            </div>
		            <div class="choose-roomtype-capacity">
			            <label class="radio-label">
			            	兩人房
			                <input type="radio" name="roomtypeCapacity" value="2" ${roomtype.roomtypeCapacity == '2' ? 'checked' : '' }>
			            </label>
		            </div>
		            <div class="choose-roomtype-capacity">
			            <label class="radio-label">
			            	三人房
			                <input type="radio" name="roomtypeCapacity" value="3" ${roomtype.roomtypeCapacity == '3' ? 'checked' : '' }>
			            </label>
		            </div>
	             	<div class="choose-roomtype-capacity">
			            <label class="radio-label">
			            	四人房
			                <input type="radio" name="roomtypeCapacity" value="4" ${roomtype.roomtypeCapacity == '4' ? 'checked' : '' }>
			            </label>
		            </div>
		            <div class="choose-roomtype-capacity">
			            <label class="radio-label">
			            	五人房
			                <input type="radio" name="roomtypeCapacity" value="5" ${roomtype.roomtypeCapacity == '5' ? 'checked' : '' }>
			            </label>
		            </div>
		        </div>
