...
<body>
	<div class="container">
		...
		<div class="main-content">
			...
			<form class="form" action="${pageContext.request.contextPath}/attraction/create">
		        <div class="form-group">
		            <label for="name">景點名稱</label>
		            <input type="text" id="name" name="attraction-name" placeholder="輸入內容">
		        </div>
		        ...
		        <div class="form-group">
		            ...
		            <input type="text" id="address" name="address" placeholder="輸入內容">
		        </div>
		        ...
		        <div class="form-group">
    				...
    				<select id="type" name="attraction-type">
	...
	<script src="${pageContext.request.contextPath}/adminsystem/attraction/form.js"></script>
